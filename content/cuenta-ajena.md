---
title: "ВНЖ номада в Испании: документы для работы в найме"
description: "Документы для ВНЖ цифрового кочевника в Испании при работе в найме: трудовой договор, доход, свидетельство СФР, страховка, переводы и пример пакета для UGE."
canonical: "https://ola-espanola.github.io/docs/cuenta-ajena.html"
---

# ВНЖ цифрового кочевника в Испании: документы для работы в найме
...
Гайд по документам для подачи на ВНЖ цифрового кочевника в Испании при работе в найме. Для заявителя из России, который работает дистанционно по трудовому договору на иностранную компанию или группу компаний вне Испании. В испанских источниках это <span lang="es">teletrabajador internacional por cuenta ajena</span>.
...
|---|---|---|
| [Свидетельство СФР](../docs/social-security-certificate.html) | Какая система соцзащиты будет применяться | Апостиль + [jurado](../docs/sworn-translation.html) перевод |
...
| Трудовой договор | Трудовые отношения минимум 3 месяца | [jurado](../docs/sworn-translation.html) перевод |
| [Банковская выписка за 3 месяца](../docs/bank-statement.html) | Поступление дохода на счет заявителя | Простой перевод |
| [Документы компании: ЕГРЮЛ или ЕГРИП](../docs/company-registration.html) | Компания существует и работает минимум 1 год | Апостиль или легализация + [jurado](../docs/sworn-translation.html) перевод |
...
1. `01_Certificado_cobertura_Seguridad_Social.pdf` - свидетельство СФР об отъезде.
...
![Раздел с файлами в форме подачи для работы в найме](../assets/images/cuenta-ajena-upload-form-rus.png)

_Раздел с файлами в форме подачи для работы в найме._
