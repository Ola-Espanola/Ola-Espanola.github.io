...
Для граждан России, которые подаются <mark style="background-color: #dff1ff; color: inherit; white-space: nowrap;">по найму</mark> у российского работодателя и сохраняют российское социальное страхование на время работы из Испании.
...
Для UGE также подготовьте [письмо работодателя](client-letter.html). В нем подтвердите направление на работу из Испании, дистанционный характер обязанностей и сохранение трудовых отношений.
...
1. Откройте [запись на прием в СФР на Госуслугах](https://www.gosuslugi.ru/671331/1/form) и войдите в учетную запись.
2. Укажите, кого записываете, и заполните данные посетителя. Если идет представитель, записывайте его.
3. Выберите тему обращения, которую согласовали с клиентской службой.
4. Выберите региональное отделение и клиентскую службу, подтвердившую прием документов.
5. Выберите свободные дату и время, подтвердите запись.
...
1. Найдите [управление Минюста в регионе выдачи свидетельства](https://minjust.gov.ru/ru/ministry/territorial_structure/). До оплаты уточните прием именно оригинала свидетельства СФР об отъезде, порядок записи и реквизиты пошлины.
2. Оплатите госпошлину 2 500 рублей. Подайте оригинал с паспортом заявителя; квитанцию возьмите с собой. Укажите страну предъявления: Испания.
3. Получите документ с апостилем. Срок Минюста составляет 3 рабочих дня; при запросе образца подписи или печати его могут продлить до 30 рабочих дней.
4. Передайте свидетельство и апостиль присяжному переводчику, уполномоченному МИД Испании.
...
4. [Минюст России: проставление апостиля](https://minjust.gov.ru/ru/activity/govservices/16/), повторно проверено 11.09.2026. Общий порядок обращения, территориальная компетенция, проверка подписи и печати, основания отказа. Указаны пошлина 2500 рублей со ссылкой на подпункт 48 пункта 1 статьи 333.33 НК РФ и срок 3 рабочих дня с продлением до 30 рабочих дней при проверке подписи и печати. Региональные реквизиты нужно брать у принимающего управления.
...
6. [СФР: способы записи на прием и кто может записаться](https://sfr.gov.ru/about/smev/elek_uslugi_sfr/), раздел «Предварительная запись на прием в СФР», обновлен 05.08.2026, проверен 11.09.2026. Последовательность: кого записать, тема, отделение и клиентская служба, дата и время. Доступно гражданам РФ, иностранцам, ИП и организациям; можно записать себя или другого человека. Подтверждены ссылка на Госуслуги и телефон 8 800 100-00-01. Это описание общей записи, не отдельный регламент выдачи свидетельства.
7. [СФР: прием по записи и в порядке живой очереди](https://sfr.gov.ru/branches/penza/news/~2026/07/14/282842), 14.07.2026. Дополнительно подтверждены оба способа приема и действующая ссылка на Госуслуги. Это не гарантия присутствия специалиста по международным соглашениям в любой клиентской службе.
...
## Проверка порядка обращения от 11.09.2026

- Повторно прочитаны тематические материалы `Doc/Telegram/topics/documents.md` и `income_work.md`, затем сообщения из `C:\Projects\Nomad\processed_nomad\clean_messages.jsonl`. Полные тексты подтверждают различия между отделениями, получение через представителя и необходимость предварительно выяснить место приема. Состав пакета и сроки в статье остаются практическими ориентирами, не единым регламентом СФР.
- `Закрытый_чат_Продление_2026-09-06/messages2.html#message2869`, 12.01.2026: маршрутизация между отделениями по месту жительства и регистрации работодателя; по итогам письменного обращения документы приняли в Отрадном. Оформление заняло 3-4 недели. `#message2872`: запрашивали приказ и договор. Поэтому инструкция начинается с согласования принимающего подразделения, не обещает прием в любом отделении.
- `Живу_в_Испании_Чат_2026-09-06/messages12.html#message13160`, 03.08.2026: перечитано описание обращения на Шевченко, согласования письма работодателя вместо приказа, заявления, регистрации обращения, паспортов и СНИЛС. Выдача во время повторного визита не представлена как обязательный срок.
- `Чат_ВНЖ_Digital_Nomad_2026-09-06/messages22.html#message24970`, 30.03.2023: запись на прием матери, которая пришла по доверенности и получила свидетельство. `messages183.html#message267251`, 29.04.2026: получение через родителей по доверенности. Не использовано ошибочное мнение автора второго сообщения о невозможности оформить доверенность за рубежом.
- `Чат_ВНЖ_Digital_Nomad_2026-09-06/messages152.html#message199013`, 04.02.2025: отсутствие слотов в календаре Одинцово. Само сообщение содержит вопрос, а не подтвержденный способ решения; рекомендация звонить при отсутствии записи основана на действующей инструкции СФР.
- Форма `https://www.gosuslugi.ru/671331/1/form` открыта в браузере: произошел переход на `https://esia.gosuslugi.ru/login/`. Вход в чужую учетную запись и создание записи не выполнялись. Дальнейшие шаги описаны по официальной странице СФР от 05.08.2026. На Госуслугах отображалось уведомление о профилактических работах.
- Точное название темы для свидетельства об отъезде в текущей форме не подтверждено. Не выдумывать пункт «Международные соглашения» или «Прочие вопросы» как название кнопки. В статье предложено выяснить тему у принимающей клиентской службы; если тема или отделение недоступны, записаться по телефону.
- Образец заявления составлен для статьи по содержанию договора и документам из практики. Это не утвержденная форма СФР. Публичное содержание не включает истории участников и их персональные данные.
