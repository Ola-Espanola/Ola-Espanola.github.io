...
Файлы с номерами 01-13 идут в том же порядке, что и обязательные строки оригинальной формы. Остальное прикладывается в раздел дополнительных документов, если относится к вашему случаю.
...
11. `11_Seguro_medico.pdf` - медицинская страховка, если она нужна до регистрации в испанской системе.
...
- `Declaracion_limite_Espana.pdf` - пояснение, что испанские клиенты не превышают допустимую часть деятельности.
