...
## Что отвечать про страну

Для апостиля не указывайте Испанию, если российская система или сотрудник из-за этого отказывает в услуге.

Причина: российские органы могут считать, что для Испании легализация не требуется, и на этом основании не принимать заявление на апостиль. На практике из-за этого указывают другую страну-участника Гаагской конвенции, для которой апостиль требуется, например Италию.
...
Апостиль Минюста ставится за 3 рабочих дня после поступления документов.
...
- во флагманских МФЦ Москвы часто укладывались примерно в 4-7 рабочих дней;
...
## Важный нюанс по стажу

СТД-СФР может не закрыть весь старый стаж. Электронная трудовая история полноценно ведется с 2020 года. Если нужен опыт до 2020 года, готовьте дополнительные подтверждения:

- бумажную трудовую книжку;
- справки от работодателей;
- трудовые договоры;
- приказы;
- другие документы, подтверждающие стаж.
