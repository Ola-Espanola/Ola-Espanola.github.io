---
title: "Выписка СТД-СФР для ВНЖ номада в Испании — гайд"
description: "Как получить выписку СТД-СФР из электронной трудовой книжки для ВНЖ цифрового кочевника в Испании: бумажный документ, апостиль и присяжный перевод."
canonical: "https://ola-espanola.github.io/docs/electronic-work-record.html"
---

# Выписка из электронной трудовой для ВНЖ номада в Испании
...
Как подготовить выписку СТД-СФР из электронной трудовой книжки для подтверждения опыта при подаче на ВНЖ цифрового кочевника в Испании: получить бумажный документ, поставить апостиль и сделать присяжный перевод.
...
> Мне нужна бумажная выписка о трудовой деятельности из Социального фонда России для апостиля. Документ нужен с подписью, печатью, прошивкой и нумерацией страниц. После выдачи хочу сразу подать его на апостиль.

Если МФЦ не выдает бумажную выписку или не может оформить ее нормально, идите в территориальное отделение СФР. Там получите бумажную выписку с подписью, печатью, прошивкой и нумерацией, а потом отдельно подайте ее на апостиль через МФЦ или напрямую в Минюст.
...
![Фрагмент страницы с печатью МФЦ](../assets/images/electronic-work-record-mfc-seal.png)
...
Это плохой маршрут для такой выписки.
...
Правильнее требовать нормально оформленный оригинал выписки:

> Прошу выдать выписку о трудовой деятельности как официальный бумажный документ для апостиля: с подписью, печатью, прошивкой и нумерацией.
...
Если при подаче заявления спрашивают страну назначения, не называйте Испанию: из-за этого Минюст может отказаться принимать документы на апостиль.
...
Бумажную выписку через СФР или МФЦ при личном обращении выдают в день обращения.
...
Срок увеличивается до 30 рабочих дней, если Минюсту нужно проверить подпись, печать или полномочия сотрудника, который подписал документ.
...
После получения апостиля отдайте документ на присяжный перевод.

Переводите те листы выписки, на которых набираются нужные 3 года опыта: работодатели, должности и даты работы. Листы с опытом, который не нужен для подтверждения этих 3 лет, можно не переводить.

Обязательно переводите весь комплект, который относится к подаче:

- листы выписки, на которых набирается нужный стаж;
- лист апостиля;
- страницу со скреплением, прошивкой, печатями и заверением;
- другие страницы, если без них непонятно, к какому документу относится апостиль или заверение.

## Проверьте полноту стажа

Выписка не означает, что старого стажа в ней не будет. У человека могут быть записи до 2020 года, если эти сведения внесены в электронную трудовую.

Но СФР отдельно указывает: электронная трудовая ведется с 2020 года, а бумажная трудовая остается источником сведений о работе до 2020 года. Поэтому не отправляйте выписку вслепую.
...
Если в выписке нет важного периода или запись слишком короткая для вашей задачи, готовьте дополнительное подтверждение: бумажную трудовую книжку, справку от работодателя, трудовой договор, приказ или другой документ по этому периоду.

## Короткий маршрут

1. Идите во флагманский МФЦ или МФЦ, который выдает бумажную выписку и принимает документы на апостиль.
2. Запросите бумажную выписку для апостиля.
3. Если МФЦ не выдает или не оформляет документ нормально, получите бумажную выписку в СФР.
...
8. Сделайте присяжный перевод нужных листов выписки, апостиля и страниц с заверением.
