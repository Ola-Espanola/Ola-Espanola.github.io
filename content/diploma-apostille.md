...
Заявление можно подать напрямую через федеральный реестр апостилей — ФИС ФБДА. Оператор системы — Рособрнадзор, а сам бумажный апостиль ставит выбранный региональный компетентный орган.

Это нормальный официальный способ подачи, а не обходной путь.

**Выберите регион**

Ссылка на ФИС ФБДА привязана к региону и выглядит так:

`https://fbda-lk.obrnadzor.gov.ru/GetApostille.aspx?region=XX`

Где `XX` — код выбранного региона. Лучше открывать ФИС ФБДА по ссылке со страницы услуги на официальном сайте регионального министерства или департамента образования: там уже будет подставлен правильный код региона.

Если сайт Рособрнадзора не открывается из-за границы, на практике может понадобиться российский VPN.
...
Укажите данные заявителя и диплома, образовательную организацию, страну предъявления документа — **Испания** — и выберите бумажный апостиль.

Для бумажного результата выбирайте вариант с **реестровой выпиской и штампом апостиля**, а не только электронную реестровую выписку.
...
После оплаты вернитесь в заявление и приложите требуемые файлы. В зависимости от формы система может запросить скан диплома, приложение, документ о смене ФИО, паспортные данные и подтверждение оплаты.
...
- [Официальная информация регионального органа о подаче через Госуслуги и ФИС ФБДА](https://minobr.e-dag.ru/activities/podtverzdenie-dokumentov-ob-obrazovanii-i-ili-o-kvalifikacii-apostil-8857)
