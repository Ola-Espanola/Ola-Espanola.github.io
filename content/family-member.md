...
| **Документ о родстве**<br>Для супруга — свидетельство о браке, для ребенка — свидетельство о рождении, для зарегистрированной пары — документ о регистрации союза. **Российские документы ЗАГС не требуют апостиля для Испании**, но нужен [`jurado` перевод](../docs/document-requirements.html#jurado-perevod). В [памятке UGE по продлению](https://www.inclusion.gob.es/documents/1823432/1826095/renovaciones_feb_2018.pdf/7e4b1631-3f10-171a-eb21-5119133d01a5?t=1664875009918) для супруга предусмотрена декларация титуляра о сохранении семейной связи и совместного проживания. Повторное свидетельство о браке в этом перечне не указано. [Подробнее ↓](#family-link)                                                                                                                                                  |
...
**Давность выдачи: общего ограничения «не старше 6 месяцев» нет.** По [разъяснению DGGM от 30 июня 2025 года](https://www.inclusion.gob.es/documents/d/migraciones/20250701-criterio-dggm-acreditacion-vinculo-matrimonial), применимому в том числе к Ley 14/2013, учитывается срок действия, если он указан в самом иностранном документе. Если срок не указан, получать повторное свидетельство только из-за давности выдачи не требуется. Обновленный документ могут запросить при обоснованных сомнениях, что брак сохраняется.
...
**Давность выдачи:** в [опубликованном перечне UGE для членов семьи](https://www.inclusion.gob.es/documents/d/unidadgrandesempresas/informacion-documentacion-pagina-web-familiares-v2) не установлен предельный срок с даты выдачи свидетельства о рождении; требования «не старше 6 месяцев» в нем нет.
...
Если текущего дохода не хватает до установленного минимума, разницу можно закрыть **ликвидными сбережениями** на весь срок разрешения. Для подтверждения сбережений UGE требует актуальный банковский сертификат; конкретный предельный срок с даты его выдачи в перечне не указан.
...
**Давность выдачи справки:** в [опубликованном перечне UGE для членов семьи](https://www.inclusion.gob.es/documents/d/unidadgrandesempresas/informacion-documentacion-pagina-web-familiares-v2) срок с даты выдачи не указан. Поэтому считать 6 месяцев подтвержденным общим сроком для подачи в UGE нельзя. Указанные выше 2 года — период проживания, за который нужны справки, а не срок их действия.
...
- DGGM, разъяснение о подтверждении иностранного брака, подписано 30 июня 2025 года; стр. 1: срок действия иностранного документа и отсутствие общего требования обновлять его по давности выдачи; распространяется в том числе на Ley 14/2013:
  https://www.inclusion.gob.es/documents/d/migraciones/20250701-criterio-dggm-acreditacion-vinculo-matrimonial
