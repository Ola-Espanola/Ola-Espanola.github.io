...
Ниже документы идут **в том же порядке, в котором они показаны в форме загрузки UGE**. Галочкой `обязательно` в интерфейсе UGE отмечены первые четыре позиции; остальные появляются в форме, но нужны в зависимости от конкретного кейса.

На скриншоте ниже — **раздел загрузки документов из электронной формы подачи UGE для члена семьи цифрового кочевника**. Основные документы загружаются в соответствующие строки формы, а дополнительные материалы по конкретному кейсу можно прикладывать через раздел **«Остальные документы»**.
...
| Документы |
|---|
| **Formulario MI-F — обязательно**<br>Подписанное заявление члена семьи. На каждого заявителя заполняется отдельная форма. [Официальная форма MI-F](https://ciudadaniaexterior.inclusion.gob.es/web/migraciones/modelos-de-solicitudes-de-la-ley-14/2013). |
| **Tasa 790 038 — обязательно**<br>На каждого заявителя оплачивается отдельная tasa, прикладывается подтверждение оплаты. |
| **Документ о родстве — обязательно**<br>Для супруга — свидетельство о браке, для ребенка — свидетельство о рождении, для зарегистрированной пары — документ о регистрации союза. **Российские документы ЗАГС не требуют апостиля для Испании**, но нужен [`jurado` перевод](../docs/document-requirements.html#jurado-perevod). При продлении UGE указывает, что достаточно declaración jurada о сохранении семейной связи. [Подробнее ↓](#family-link) |
| **Паспорт члена семьи — обязательно**<br>Полная копия действующего паспорта, **все страницы**. |
| **Достаточные экономические средства**<br>При одновременной подаче титуляр подтверждает нужный доход с учетом всей семьи. Если familiar присоединяется позже, средства титуляра подтверждаются заново. [Подробнее ↓](#family-income) |
| **Государственное или частное медицинское страхование**<br>**Для обычного супруга или ребенка титуляра по контракту / autónomo отдельный частный полис не нужен**, если после одобрения титуляр входит в испанскую Seguridad Social и familiar имеет право быть beneficiario. **Для типичного российского кейса по найму** нужен частный полис, если нет отдельного документа о государственном медицинском покрытии в Испании. [Подробнее ↓](#family-insurance) |
| **Подтверждение экономической зависимости совершеннолетнего ребенка**<br>Только если подается совершеннолетний ребенок, который должен подтвердить материальную зависимость. [Подробнее ↓](#adult-child) |
| **Подтверждение нахождения восходящего родственника на иждивении**<br>Только если подается родитель или другой восходящий родственник. [Подробнее ↓](#ascendant) |
| **Справка о несудимости — если требуется**<br>Для совершеннолетнего: российская справка — **с апостилем + `jurado` переводом**. Не требуется лицам младше 18 лет. UGE также указывает, что она не нужна при предыдущей резиденции в Испании более 6 месяцев, когда соответствующая справка уже была представлена. [Подробнее](../docs/criminal-record-certificate.html) |

### Остальные документы

Эти документы не показаны на присланном экране UGE как отдельные строки, но могут входить в пакет и загружаться через раздел **«Остальные документы»**:

| Остальные документы |
|---|
| **Declaración responsable об отсутствии судимости за последние 5 лет**<br>Отдельная декларация на испанском; перевод не нужен. |
| **Подтверждение легального нахождения в Испании**<br>Нужно показать, что именно этот член семьи находится в Испании легально на дату подачи. `Declaración de entrada` прикладывается только когда она нужна для подтверждения въезда. [Подробнее](../docs/legal-stay-in-spain.html) |
| **Designación de representante — только если подает представитель**<br>Документ должен давать представителю право подписать заявление и подать документы. |
| **Дополнительные пояснения и документы по конкретному кейсу**<br>Например, нотариальное согласие второго родителя, дополнительные доказательства зависимости или пояснительное письмо. |
...
Для обычного совершеннолетнего супруга пакет выглядит примерно так — сначала в порядке строк формы UGE, затем дополнительные документы:
...
Для несовершеннолетнего ребенка базово, в порядке формы UGE:
...
- В форме загрузки UGE документы идут в порядке: MI-F → tasa → vínculo familiar → паспорт → recursos económicos → seguro → dependencia descendiente mayor de 18 → ascendiente a cargo → antecedentes penales.
