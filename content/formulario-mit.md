...
<a href="../assets/images/formulario-mit-example.png" style="display: block; max-width: 100%; overflow-x: auto;"><img src="../assets/images/formulario-mit-example.png" alt="Образец заполнения Formulario MIT: Иван Иванов, представитель Петр Петров и поле NRC" width="1571" height="2222" style="width: min(648px, 120%); max-width: none; height: auto;"></a>
...
- Изображение увеличено на 20% относительно исходного отображения: ширина до 648 пикселей или 120% ширины колонки. В узкой колонке доступна горизонтальная прокрутка внутри образца; нажатие открывает полный размер.
